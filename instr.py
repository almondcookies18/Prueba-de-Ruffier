...
txt_hello = 'Bienvenido al test de Ruffier!!!'
txt_next = 'Siguiente'
...
txt_workheart = 'Rendimiento cardiaco:'
txt_res1 = 'Bajo, acuda al medico de inmediato.'
txt_res2 = 'Insatisfactorio. Vea a su médico'
